# 009E — RINGKASAN CPL LENGKAP & MATRIKS PEMETAAN BoK, PL, PEMINATAN, DAN VMTS
...
## 1. TABEL RINGKASAN 14 CPL SISTEKIN

| No | Kode CPL | Kategori | Ringkasan Rumusan Capaian Pembelajaran Lulusan | Target Bloom | Sumber Rujukan |
|:---:|:---:|---|---|:---:|---|
...
| 9 | **KK1** | Keterampilan Khusus | Mampu merancang dan mengembangkan sistem informasi cerdas terintegrasi kecerdasan artifisial (AI/ML, NLP, Computer Vision, Smart Sys, DSS). | C6 (*Create*) | IS2020 K01, K09, K13, K16 |
| 10 | **KK2** | Keterampilan Khusus | Mampu merekayasa pipeline data skala besar (*Data Engineering*), model machine learning/deep learning, serta pipeline MLOps dan Business Intelligence. | C6 (*Create*) | IS2020 K01, K13, K16 |
| 11 | **KK3** | Keterampilan Khusus | Mampu mengintegrasikan infrastruktur cloud (DevOps/IaC), sistem sensor IoT terdistribusi, dan menerapkan strategi pertahanan keamanan siber. | C6 (*Create*) | IT2017 KK2-3, IS2020 K02, K05-6 |
| 12 | **KK4** | Keterampilan Khusus | Mampu merancang tata kelola TI (*IT Governance*), audit keamanan sistem informasi, serta memastikan kepatuhan regulasi (COBIT, ITIL, ISO 27001). | C5 (*Evaluate*) | IS2020 K05, K06, K07, K14 |
| 13 | **KK5** | Keterampilan Khusus | Mampu merancang UI/UX berbasis riset dan membangun platform digital skalabel modern (*Microservices, Full-Stack Web/Mobile, API, SaaS*). | C6 (*Create*) | IT2017 KK1, IS2020 K03-4, K08, K10-12 |
| 14 | **KK6** | Keterampilan Khusus | Mampu merancang, memvalidasi model bisnis (*Lean Startup/MVP*), mengelola proyek agile, serta mendirikan usaha rintisan *technopreneurship*. | C6 (*Create*) | IS2020 K08, K15, IT2017 KK1 |
...
## 4. MATRIKS PEMETAAN CPL ↔ 4 PROFIL LULUSAN (PL)

| Profil Lulusan | Peminatan Terkait | S1 | KU1 | KU2 | KU3 | P1 | P2 | P3 | P4 | KK1 | KK2 | KK3 | KK4 | KK5 | KK6 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **PL-1: Intelligent IS Developer & AI Engineer** | P1 | ⭐ | ⭐ | ⭐ | ⭐ | ⭐ | ⭐ | | ⭐ | ⭐⭐⭐ | ⭐⭐⭐ | | | ⭐ | |
| **PL-2: Cloud Infrastructure & Cybersecurity Specialist** | P2 | ⭐ | ⭐ | ⭐ | ⭐ | ⭐ | | ⭐ | | | | ⭐⭐⭐ | ⭐⭐⭐ | | |
| **PL-3: UI/UX Designer & Digital Platform Engineer** | P3 | ⭐ | ⭐ | ⭐ | ⭐ | | ⭐ | | ⭐ | | | | | ⭐⭐⭐ | ⭐⭐ |
| **PL-4: Digital Technopreneur & IT Product Innovator** | P3 / P1 / P2 | ⭐ | ⭐ | ⭐ | ⭐ | | ⭐ | ⭐ | ⭐ | ⭐ | | | | ⭐⭐ | ⭐⭐⭐ |

*Keterangan Bobot:*  
* `⭐⭐⭐` : Kompetensi Utama (*Major Specialty*)  
* `⭐⭐` : Kompetensi Pendukung Kuat (*Strong Supporting*)  
* `⭐` : Kompetensi Fondasi Bersama (*Foundational / Complementary*)  

---

## 5. MATRIKS PEMETAAN CPL ↔ 3 JALUR PEMINATAN

| Kode Peminatan | Nomenklatur Jalur Peminatan | S1 | KU1 | KU2 | KU3 | P1 | P2 | P3 | P4 | KK1 | KK2 | KK3 | KK4 | KK5 | KK6 |
|:---:|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
## 6. MATRIKS KESELARASAN CPL ↔ VISI KEILMUAN VMTS 2045

| Elemen Kunci VMTS SISTEKIN 2045 | CPL yang Selaras & Mengakomodasi |
|---|---|
| *"Sistem dan teknologi informasi cerdas"* | `P1`, `P2`, `KK1`, `KK2` |
| *"Terintegrasi kecerdasan artifisial"* | `P1`, `P2`, `KK1`, `KK2`, `KK3` |
| *"Technopreneurship berbasis kebutuhan masyarakat"* | `P2`, `KK5`, `KK6` |
| *"Bermutu, mandiri, dan bermartabat"* | `S1`, `KU1`, `KU3`, `P3`, `KK4` |
| *"Berwawasan global"* | `KU2`, `P3`, `KK3`, `KK5` |

---
*Disahkan sebagai Dokumen Resmi 009E — Kurikulum OBE Revisi SISTEKIN 2026.*  

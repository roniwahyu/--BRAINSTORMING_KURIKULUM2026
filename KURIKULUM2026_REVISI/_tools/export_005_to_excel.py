...
def build_005_excel():
    ...
    pem_data = [
        ["P1: Integrated Smart Systems", "STA-501", "Decision Support Systems", "3", "+Praktikum", "Sem 5", "Sistem Pendukung Keputusan & Fuzzy Logic"],
        ["P1: Integrated Smart Systems", "STA-601", "Metode Komputasi & Numerik", "3", "+Praktikum", "Sem 6", "Analisis Numerik Lanjut & Optimasi"],
        ["P1: Integrated Smart Systems", "STA-602", "Intelligent Agent Systems", "3", "+Praktikum", "Sem 6", "Multi-Agent Systems & Algoritma Heuristik"],
        ["P1: Integrated Smart Systems", "STA-701", "MLOps & AI Pipeline Engineering", "3", "+Praktikum", "Sem 7", "Automasi Pipeline Model AI & CI/CD ML"],
        ["P1: Integrated Smart Systems", "STA-702", "Conversational AI & Assistant", "3", "+Praktikum", "Sem 7", "NLP, LLM Integration & Chatbot Enterprise"],
        ["P1: Integrated Smart Systems", "STA-703", "Smart Surveillance & IoT Analytics", "3", "+Praktikum", "Sem 7", "Computer Vision & Video Stream Analytics"],
        ["P2: Cloud Infra & Cyber", "STB-501", "Network Security & Digital Forensics", "3", "+Praktikum", "Sem 5", "Forensik Jaringan, Threat Hunting & Incident"],
        ["P2: Cloud Infra & Cyber", "STB-601", "Cloud Architecture & DevOps", "3", "+Praktikum", "Sem 6", "IaC Terraform, Kubernetes & CI/CD Cloud"],
        ["P2: Cloud Infra & Cyber", "STB-602", "Cybersecurity Risk Management", "3", "Teori", "Sem 6", "Framework NIST, ISO 27005 & Mitigasi Risiko"],
        ["P2: Cloud Infra & Cyber", "STB-701", "IT Governance & Compliance COBIT", "3", "Teori", "Sem 7", "Tata Kelola TI COBIT 2019 & Audit Sistem"],
        ["P2: Cloud Infra & Cyber", "STB-702", "IT Service Management ITIL 4", "3", "Teori", "Sem 7", "Manajemen Layanan TI Berstandar Global"],
        ["P2: Cloud Infra & Cyber", "STB-703", "Enterprise Architecture TOGAF", "3", "Teori", "Sem 7", "Arsitektur Enterprise & Keselarasan Bisnis"],
        ["P3: Digital Platform Eng", "STC-501", "UX Research & Interface Design", "3", "+Praktikum", "Sem 5", "Riset Pengguna, Usability Testing & Figma"],
        ["P3: Digital Platform Eng", "STC-601", "Rekayasa Proses Bisnis & Otomasi", "3", "+Praktikum", "Sem 6", "BPMN, Low-Code Automation & Workflow Eng"],
        ["P3: Digital Platform Eng", "STC-602", "Rekayasa Aplikasi Industri Vertikal", "3", "+Praktikum", "Sem 6", "Smart Agriculture, HealthTech & Supply Chain"],
        ["P3: Digital Platform Eng", "STC-701", "Immersive Media & XR Development", "3", "+Praktikum", "Sem 7", "AR/VR/XR Terapan Interaktif di Unity"],
        ["P3: Digital Platform Eng", "STC-702", "SaaS Architecture & Multi-Tenancy", "3", "+Praktikum", "Sem 7", "Arsitektur Multi-Tenant, API Gateway & Cloud"],
        ["P3: Digital Platform Eng", "STC-703", "Digital Product Management", "3", "Teori", "Sem 7", "Product Lifecycle, Growth Metrics & Agile PM"],
    ]

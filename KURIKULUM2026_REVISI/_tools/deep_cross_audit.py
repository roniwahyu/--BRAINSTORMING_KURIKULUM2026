...
CANONICAL_COURSES = {
    ...
    "STI-204": ("Matematika Diskrit dan Logika", 3, 2, "Core STI"),
    "STI-205": ("Aljabar Linear dan Matriks", 3, 2, "Core STI"),
    "STI-306": ("Analisis dan Perancangan Sistem Informasi", 3, 3, "Core STI"),
    "STI-307": ("Sistem Cerdas", 2, 3, "Core STI"),
    "STI-308": ("UI/UX Design & Prototyping", 3, 3, "Core STI"),
    "STI-309": ("Rekayasa Perangkat Lunak", 3, 3, "Core STI"),
    "STI-310": ("Sistem Operasi", 3, 3, "Core STI"),
    "STI-311": ("Web Front End Development", 3, 3, "Core STI"),
    "STI-312": ("Jaringan Komputer", 3, 3, "Core STI"),
    "STI-413": ("Machine Learning", 3, 4, "Core STI"),
    "STI-415": ("Data Warehouse & Business Intelligence", 3, 4, "Core STI"),
    "STI-414": ("Pengantar NLP & Temu Balik Informasi", 2, 4, "Core STI"),
    "STI-417": ("Komputasi Awan", 3, 4, "Core STI"),
    "STI-418": ("Dasar Keamanan Informasi", 2, 4, "Core STI"),
    "STI-416": ("Web Back End Development", 3, 4, "Core STI"),
    "STI-519": ("Deep Learning & Neural Networks", 3, 5, "Core STI"),
    "STI-520": ("Data Mining & Visualisasi Data", 3, 5, "Core STI"),
    "STI-521": ("Internet of Things", 3, 5, "Core STI"),
    "STI-522": ("Pemrograman Aplikasi Mobile", 3, 5, "Core STI"),
    "STI-523": ("Manajemen Proyek TI", 3, 5, "Core STI"),
    "STI-624": ("Integrasi Layanan Cerdas AI", 3, 6, "Core STI"),
    "STI-625": ("Smart City & Pemerintahan Digital", 2, 6, "Core STI"),
    "STI-626": ("Keamanan Informasi Lanjut", 3, 6, "Core STI"),
    "STI-627": ("Digital Platform Engineering", 3, 6, "Core STI"),

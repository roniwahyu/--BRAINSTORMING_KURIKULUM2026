...
|:---:|:---:|---|:---:|:---:|:---:|---|---|
| 1 | `STA-01` | Decision Support Systems | 3 | +P | Sem 5 | `STI-307` | P1: Integrated Smart Systems |
| 2 | `STA-02` | Computational Methods and Numerics | 3 | +P | Sem 6 | `STI-102`, `STI-205` | P1: Integrated Smart Systems |
| 3 | `STA-03` | Intelligent Agent Systems | 3 | +P | Sem 6 | `STI-307` | P1: Integrated Smart Systems |
| 4 | `STA-04` | MLOps and AI Pipeline | 3 | +P | Sem 7 | `STI-413`, `STI-624` | P1: Integrated Smart Systems |
| 5 | `STA-05` | Conversational AI and Intelligent Assistant | 3 | +P | Sem 7 | `STI-413`, `STI-416` | P1: Integrated Smart Systems |
| 6 | `STA-06` | Smart Surveillance and IoT Analytics | 3 | +P | Sem 7 | `STI-626`, `STI-521` | P1: Integrated Smart Systems |
| 7 | `STB-01` | Network Security and Digital Forensics | 3 | +P | Sem 5 | `STI-312`, `STI-418` | P2: Cloud Infra & Cybersecurity |
| 8 | `STB-02` | Cloud Architecture & DevOps | 3 | +P | Sem 6 | `STI-417` | P2: Cloud Infra & Cybersecurity |
| 9 | `STB-03` | Cybersecurity Risk Management | 3 | Teori | Sem 6 | `STI-418` | P2: Cloud Infra & Cybersecurity |
| 10 | `STB-04` | IT Governance & Compliance (COBIT 2019) | 3 | Teori | Sem 7 | `STI-101` | P2: Cloud Infra & Cybersecurity |
| 11 | `STB-05` | IT Service Management (ITIL 4) | 3 | Teori | Sem 7 | `STI-101` | P2: Cloud Infra & Cybersecurity |
| 12 | `STB-06` | Enterprise Architecture (TOGAF) | 3 | Teori | Sem 7 | `STI-306` | P2: Cloud Infra & Cybersecurity |
| 13 | `STC-01` | User Experience Research & Design | 3 | +P | Sem 5 | `STI-308` | P3: Digital Platform Engineering |
| 14 | `STC-02` | Rekayasa & Otomasi Proses Bisnis (BPA) | 3 | +P | Sem 6 | `STI-306` | P3: Digital Platform Engineering |
| 15 | `STC-03` | Rekayasa Aplikasi Industri Vertikal (FinTech & EdTech) | 3 | +P | Sem 6 | `STI-416` | P3: Digital Platform Engineering |
| 16 | `STC-04` | Immersive Media & XR Development | 3 | +P | Sem 7 | `STI-311` | P3: Digital Platform Engineering |
| 17 | `STC-05` | SaaS Architecture & Multi-Tenancy | 3 | +P | Sem 7 | `STI-416` | P3: Digital Platform Engineering |
| 18 | `STC-06` | Digital Product Management & Agile Practices | 3 | Teori | Sem 7 | `STI-523` | P3: Digital Platform Engineering |

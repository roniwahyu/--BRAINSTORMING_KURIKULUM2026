...
> "**Dihapus** dari K2026 (bertumpang dengan ranah riset algoritma Prodi TI, Dok. 016). Unsur ekstraksi fitur sinyal terserap parsial pada `STI-726` Deep Learning & `STA-703` Smart Surveillance. Diakui sebagai kredit bebas 3 SKS"
...
|:---:|---|:---:|
| `STI-726` Deep Learning & Neural Networks | `Feature Extraction` 1× (Pekan 7: *"Transfer Learning: Feature Extraction vs Fine-Tuning Model Vision"*), `Time Series` 1× (Pekan 12: *"Gated Architectures: LSTM Cells, GRU Cells untuk Time Series"*) | ⚠️ **Sebagian** — konteks vision & deret waktu, bukan pengolahan sinyal |
...
| Pengolahan sinyal (`STI-638`) | `STI-726` Deep Learning & Neural Networks | 0 dari 16 | **0,0%** | ❌ Gagal |

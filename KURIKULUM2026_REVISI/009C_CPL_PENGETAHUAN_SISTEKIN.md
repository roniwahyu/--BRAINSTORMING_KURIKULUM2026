...
| **P3** | Menguasai prinsip dan konsep infrastruktur TI, jaringan komputer, komputasi awan (*cloud*), keamanan informasi & siber, tata kelola TI, serta manajemen proyek sistem dan teknologi informasi. | IS2020 CPL-P03, CPL-P06, CPL-P07, CPL-P08, IT2017 P2 | Infrastruktur TI, Cloud, Cyber & Governance | **C4 (Analyze)** |
...
| 3 | Menguasai prinsip desain antarmuka, *heuristics usability*, dan arsitektur *microservices*. | Laporan Audit Desain UI/UX & Platform Architecture. |
...
| Kode | Jalur Peminatan Spesialisasi | P1 (Sains/Mat) | P2 (Sistem Informasi) | P3 (Infra/Cyber/GRC) | P4 (Data/Platform) |
|:---:|---|:---:|:---:|:---:|:---:|
| **P1** | Integrated Smart Systems | ✅ Fondasi AI | ✅ Sistem Cerdas | | ✅ Data Mining & AI |
| **P2** | Cloud Infrastructure & Cybersecurity | ✅ Fondasi Infra | | ✅ Cloud, IoT & Cyber | |
| **P3** | Digital Platform Engineering | | ✅ Proses Bisnis | | ✅ UI/UX & Web/Mobile |

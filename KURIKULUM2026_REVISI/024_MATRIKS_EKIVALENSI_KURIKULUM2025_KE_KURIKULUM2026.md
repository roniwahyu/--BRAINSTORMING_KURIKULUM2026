...
> 2. **Gap fondasi K2025:** K2025 **tidak memiliki** mata kuliah Jaringan Komputer maupun Arsitektur/Organisasi Komputer. Keduanya menjadi MK baru wajib (`STI-307`, `STI-103`) dan berstatus prasyarat bagi Cloud, IoT, dan Keamanan pada K2026.
...
| 6 | `STI-103` | Logika Informatika | 2 | `STI-201` | Matematika Diskrit dan Logika | 3 | 2 | **E3** | Dilebur bersama `STI-205` Matematika Diskrit — lihat klaster G-1 |
...
| 10 | `STI-205` | Matematika Diskrit | 2 | `STI-201` | Matematika Diskrit dan Logika | 3 | 2 | **E3** | Dilebur bersama `STI-103` Logika Informatika — lihat klaster G-1 |
...
| 13 | `STI-208` | Visualisasi Data dan Dashboard Interaktif (+P) | 2 | `STI-503` | Data Mining & Visualisasi Data (+P) | 3 | 5 | **E3** | Dilebur bersama `STI-740` Penambangan Data dan Visualisasi — lihat klaster G-2 |
| 14 | `STI-209` | Aljabar Linear | 4 | `STI-202` | Aljabar Linear dan Matriks | 3 | 2 | **E1** | SKS diturunkan 4 → 3 (rasionalisasi Dok. 014). Selisih 1 SKS menjadi kredit bebas |

### 3.3 EKIVALENSI MK SEMESTER 3 KURIKULUM 2025 (20 SKS)

| No | Kode K2025 | Nama MK Kurikulum 2025 | SKS | Kode K2026 | Nama MK Kurikulum 2026 (Revisi) | SKS | Smt | Kat | Catatan Penyetaraan |
|:---:|:---:|---|:---:|:---:|---|:---:|:---:|:---:|---|
| 15 | `STI-310` | Analisis dan Perancangan Sistem Informasi | 3 | `STI-301` | Analisis dan Perancangan Sistem Informasi | 3 | 3 | **E1** | Konten dan SKS identik; kode dinomorulang |
| 16 | `STI-311` | Sistem Operasi | 3 | `STI-305` | Sistem Operasi | 3 | 3 | **E1** | Konten dan SKS identik; kode dinomorulang |
| 17 | `STI-312` | Pemrograman Web (+P) | 3 | `STI-306` | Web Front End Development (+P) | 3 | 3 | **E2** | K2026 memisahkan front end dan back end. `STI-312` diakui sebagai `STI-306`; mahasiswa **tetap wajib** menempuh `STI-407` Web Back End Development (3 SKS) |
...
| 25 | `STI-418` | Sistem Cerdas | 2 | `STI-302` | Sistem Cerdas | 2 | 3 | **E1** | Nama dan SKS identik; posisi bergeser Sem 4 → Sem 3 |
| 26 | `STI-419` | Mobile Application Development (+P) | 3 | `STI-505` | Pemrograman Aplikasi Mobile (+P) | 3 | 5 | **E1** | Konten dan SKS setara; posisi bergeser Sem 4 → Sem 5 |
| 27 | `STI-420` | Semantic Web dan Ontologi | 2 | `STI-403` | Pengantar NLP & Information Retrieval (+P) | 2 | 4 | **E2** | Reorientasi materi: ontologi/RDF → NLP & temu kembali informasi. Overlap ± 60% (representasi pengetahuan & pengindeksan semantik) → wajib uji penyetaraan |
| 28 | `STI-421` | Manajemen Proyek TI | 2 | `STI-506` | Manajemen Proyek Teknologi Informasi | 3 | 5 | **E2** | SKS naik 2 → 3 (penambahan praktik alat manajemen proyek Agile) → wajib tugas penyetaraan 1 SKS |
| 29 | `STI-422` | E-Commerce dan Digital Business | 3 | `STI-701` | Inovasi Teknologi dan Startup Digital (+P) | 3 | 7 | **E2** | Reorientasi dari model bisnis e-commerce ke inovasi produk & startup (penegasan batas dengan Prodi Bisnis Digital). Overlap ± 65% → wajib uji penyetaraan |
...
| 34 | `STI-525` | Pemrograman Lanjut dan API (+P) | 3 | `STI-407` | Web Back End Development (+P) | 3 | 4 | **E1** | Konten inti (REST API, layanan sisi server) setara; SKS identik; posisi bergeser Sem 5 → Sem 4 |
...
| 46 | `STI-637` | Smart City dan Sistem Pemerintahan Digital | 3 | `STI-602` | Smart City & Pemerintahan Digital | 2 | 6 | **E1** | SKS diturunkan 3 → 2 (rasionalisasi Dok. 014). Selisih 1 SKS menjadi kredit bebas |
| 47 | `STI-638` | Intelligent Signal Processing | 3 | — | *Tidak ada padanan* | — | — | **E5** | **Dihapus** dari K2026 (bertumpang dengan ranah riset algoritma Prodi TI, Dok. 016). Unsur ekstraksi fitur sinyal terserap parsial pada `STI-501` Deep Learning & `STA-06` Smart Surveillance. Diakui sebagai kredit bebas 3 SKS |
...
| 50 | `STI-739` | Platform Literasi dan Edukasi Digital (+P) | 3 | `STI-604` | Digital Platform Engineering (+P) | 3 | 6 | **E2** | Reorientasi dari platform edukasi domain-spesifik ke rekayasa platform digital generik (arsitektur layanan, skalabilitas, DevOps dasar). Overlap ± 60% → wajib uji penyetaraan |
...
|:---:|---|:---:|---|:---:|:---:|---|
| **G-1** | `STI-103` Logika Informatika (2) + `STI-205` Matematika Diskrit (2) | 4 | `STI-201` Matematika Diskrit dan Logika | 3 | −1 | Logika proposisi dan aljabar Boolean adalah subbagian kanonik Matematika Diskrit (BK-IS10). Pemisahan menimbulkan pengulangan materi ± 40% |
| **G-2** | `STI-208` Visualisasi Data & Dashboard Interaktif (2) + `STI-740` Penambangan Data dan Visualisasi (3) | 5 | `STI-503` Data Mining & Visualisasi Data | 3 | −2 | Visualisasi tanpa didahului penambangan data menyebabkan MK Sem 2 mengajarkan alat tanpa substansi analitik. Digabung pada Sem 5 setelah `STI-401` Machine Learning |
| **G-3** | `STI-314` Interaksi Manusia dan Komputer (3) + `STI-635` Desain & Evaluasi Antarmuka Pengguna UI/UX (3) | 6 | `STI-303` UI/UX Design & Prototyping | 3 | −3 | Dua MK mengampu BK yang sama (BK-IS13 / BK-IT09) dengan overlap ± 70%. Materi riset pengguna lanjutan dipindahkan ke elektif `STC-01` UX Research & Design |
...
| **TOTAL** | **8 MK Kurikulum 2025** | **19 SKS** | **4 MK Kurikulum 2026** | **12 SKS** | **−7 SKS** | Efisiensi 7 SKS direalokasi ke `STI-103` Arsitektur STI, `STI-307` Jaringan Komputer, dan `FST-204` Pengantar AI & Data |
...
| `STI-103` | Logika Informatika | 2 | **Arsitektur dan Organisasi Sistem Teknologi Informasi** | 3 | 🔴 **Tinggi** | Logika Informatika K2025 dipetakan ke `STI-201` (klaster G-1). `STI-103` K2026 adalah **MK baru** yang wajib ditempuh |
...
| `STI-405`/`STI-313` | Keamanan Informasi Dasar (`STI-313`) | 2 | Dasar Keamanan Informasi (`STI-405`) | 2 | 🟢 **Rendah** | Kode berbeda, tidak berkolisi. Dicatat sebagai perubahan penomoran murni |
...
|:---:|:---:|---|:---:|:---:|:---:|---|
| 1 | `STI-103` | Arsitektur dan Organisasi Sistem Teknologi Informasi | 3 | 1 | Core STI | **Gap fondasi kritis K2025.** K2025 tidak mengajarkan organisasi komputer, hierarki memori, maupun representasi data tingkat mesin (BK-IS03 / BK-IT05). Menjadi prasyarat `STI-305` Sistem Operasi dan `STI-307` Jaringan Komputer |
| 2 | `STI-307` | Jaringan Komputer (+P) | 3 | 3 | Core STI | **Gap fondasi kritis K2025.** K2025 melompat langsung ke `STI-529` Keamanan Jaringan tanpa MK jaringan komputer dasar. Prasyarat wajib bagi Cloud (`STI-404`), IoT (`STI-504`), dan Keamanan (`STI-405`) |
| 3 | `STI-603` | Keamanan Informasi Lanjut | 3 | 6 | Core STI | Penguatan jenjang keamanan bertingkat (dasar Sem 4 → lanjut Sem 6) untuk memenuhi CPL KK4 (audit, GRC & tata kelola TI) pada jalur wajib, tidak hanya elektif |
...
| MK Inti Core STI (28 MK) | 79 | **70** | 9 | `STI-103` (3), `STI-307` (3), `STI-603` (3) |
...
> [!NOTE]
> **Rincian status pengakuan (jalur P1/P2):** Dari 114 SKS MK wajib yang diakui, **24 SKS berstatus bersyarat (E2)** dan mensyaratkan uji penyetaraan, yaitu `FST-203`, `STI-306`, `STI-404`, `STI-501`, `STI-506`, `STI-601`, `STI-604`, dan `STI-701`. Pada jalur P1 terdapat tambahan 3 SKS bersyarat (`STA-02`), sedangkan `FST-101` (2 SKS) bersyarat melalui skema E4.
...
|---|:---:|:---:|---|---|
| **Telah selesai Sem 1–2** | 36 SKS | ± 31 SKS | `STI-103` (3), `FST-204` (2), `STI-307` (3) | **Migrasi penuh ke K2026.** Sisipkan 3 MK baru secara bertahap pada Sem 3–4 (maksimum +3 SKS per semester) agar beban per semester tetap ≤ 22 SKS |
| **Telah selesai Sem 3–4** | 76 SKS | ± 66 SKS | `STI-103` (3), `STI-307` (3), `FST-204` (2), `FST-610` (3) | **Migrasi selektif.** `STI-103` dan `STI-307` wajib pada Sem 5 karena menjadi prasyarat Cloud, IoT, dan Keamanan; `FST-610` Capstone pada Sem 7 |
| **Telah selesai Sem 5–6** | 118 SKS | ± 106 SKS | `FST-610` (3) dan `STI-603` (3) atau ekuivalen | **Tetap pada K2025** dengan penyisipan `FST-610` Capstone Project FSTI sebagai pengganti 3 SKS MK pilihan. Migrasi penuh tidak efisien karena defisit melampaui 24 SKS |
...
| `STI-103` | 2 | `STI-201` | 3 | E3/G-1 | C | Bersyarat |
| `STI-205` | 2 | `STI-201` | 3 | E3/G-1 | C | Bersyarat |
| `STI-104` | 4 | `STI-102` | 3 | E1 | C | Tidak |
| `STI-206` | 3 | `FST-207` | 3 | E1 | C | Tidak |
| `STI-207` | 3 | `FST-203` | 3 | E2 | C | **Ya** |
| `STI-208` | 2 | `STI-503` | 3 | E3/G-2 | C | Bersyarat |
| `STI-740` | 3 | `STI-503` | 3 | E3/G-2 | C | Bersyarat |
| `STI-209` | 4 | `STI-202` | 3 | E1 | C | Tidak |
| `STI-310` | 3 | `STI-301` | 3 | E1 | C | Tidak |
| `STI-311` | 3 | `STI-305` | 3 | E1 | C | Tidak |
| `STI-312` | 3 | `STI-306` | 3 | E2 | C | **Ya** |
| `STI-313` | 2 | `STI-405` | 2 | E1 | C | Tidak |
| `STI-314` | 3 | `STI-303` | 3 | E3/G-3 | C | Bersyarat |
| `STI-635` | 3 | `STI-303` | 3 | E3/G-3 | C | Bersyarat |
...
| `STI-418` | 2 | `STI-302` | 2 | E1 | C | Tidak |
| `STI-419` | 3 | `STI-505` | 3 | E1 | C | Tidak |
| `STI-420` | 2 | `STI-403` | 2 | E2 | C | **Ya** |
| `STI-421` | 2 | `STI-506` | 3 | E2 | C | **Ya** |
| `STI-422` | 3 | `STI-701` | 3 | E2 | C | **Ya** |
| `STI-423` | 3 | — | — | E5 | — | Kredit Bebas |
| `STI-424` | 3 | `FST-408` | 3 | E1 | C | Tidak |
| `STI-525` | 3 | `STI-407` | 3 | E1 | C | Tidak |
| `STI-526` | 3 | `STI-504` | 3 | E1 | C | Tidak |
| `STI-527` | 2 | `STI-404` | 3 | E2 | C | **Ya** |
| `STI-528` | 2 | `STI-403` | 2 | E1 | C | Tidak |
| `STI-529` | 3 | `STB-01` | 3 | E1 | C | Tidak |
| `STI-530` | 3 | `STI-402` | 3 | E1 | C | Tidak |
| `STI-632` | 3 | `STI-304` | 3 | E1 | C | Tidak |
| `STI-633` | 3 | `STA-01` | 3 | E1 | C | Tidak |
| `STI-634` | 3 | `STI-501` | 3 | E2 | C | **Ya** |
| `STI-636` | 3 | `STI-401` | 3 | E1 | C | Tidak |
| `STI-637` | 3 | `STI-602` | 2 | E1 | C | Tidak |
| `STI-638` | 3 | — | — | E5 | — | Kredit Bebas |
| `STI-739` | 3 | `STI-604` | 3 | E2 | C | **Ya** |
| `STI-741` | 3 | `STI-601` | 3 | E2 | C | **Ya** |
| `STI-742` | 3 | `STI-701` | 3 | E2 | C | **Ya** |

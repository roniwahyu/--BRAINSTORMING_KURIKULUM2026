...
├── 030_JUSTIFIKASI_AKADEMIS_DAN_BoK_STA02_COMPUTATIONAL_METHODS_SEBAGAI_MK_PILIHAN.md ⭐ (Justifikasi Akademis & Audit BoK Penetapan STA-601 Komputasi Numerik sebagai MK Pilihan P1)
...
├── 039_LAMPIRAN_SIAP_BUKU_KPT_SISTEKIN_2026.md ⭐ (Kompilasi 14 Lampiran Status SIAP Buku KPT)
├── 040_LAMPIRAN_RAKIT_BUKU_KPT.md ⭐ (Kompilasi 4 Lampiran Status RAKIT Buku KPT)
├── 041_LAMPIRAN_BARU_BUKU_KPT.md ⭐ (Kompilasi 4 Lampiran Status PENULISAN BARU Buku KPT)

...
├── 038_RENCANA_KONTEN_LAMPIRAN_BUKU_KPT.md ⭐ (Pemetaan Komprehensif 38 Butir Lampiran Buku KPT 2024: 14 SIAP, 7 RAKIT, 4 BARU, 13 UPPS)
├── 039_RENCANA_IMPLEMENTASI_LAMPIRAN_KLASTER_AKADEMIK_INTI_10_SD_19.md ⭐ (Implementation Plan Perakitan Lampiran 10 s.d. 19 Klaster Akademik Inti SIAP)
...
- **Dokumen 026** mengaudit 2 MK berkategori E5 (`STI-423` Game Design & Gamifikasi Sosial, `STI-638` Intelligent Signal Processing) dan menemukan **3 klaim penyerapan pada Dok 024 tidak terbukti**: gamifikasi diklaim terserap di `STC-01`/`STC-04` (hasil pemindaian: nol kemunculan; jangkar sebenarnya `STC-03` Pekan 9), sinyal diklaim terserap di `STA-06` (nol kemunculan), dan sitasi "Dok. 016" tidak dapat dilacak (kedua MK tidak pernah dibahas di Dok 016/017).
- **Uji ambang E2** (overlap 60–85%) atas 5 kandidat MK pengganti: seluruhnya gagal, overlap tertinggi hanya **6,2%** (`STC-03`). Karena itu **status E5 dipertahankan** — memaksakan ke E2 akan mengubah angka konsensus (E5 2→0 MK, simulasi 120/120/117 → 123/120/120 SKS) tanpa dasar substantif, dan pengakuannya tidak setara antar jalur.

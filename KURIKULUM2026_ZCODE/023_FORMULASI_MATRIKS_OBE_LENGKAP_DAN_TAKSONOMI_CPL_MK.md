...
```mermaid
graph LR
    VMTS["Visi 2045: AI Smart Systems & Technopreneurship"] --> PEO1["PEO-1: Praktisi / AI Specialist"]
    VMTS --> PEO2["PEO-2: Technopreneur / Founder"]
    VMTS --> PEO3["PEO-3: Akademisi / Researcher"]
    
    PEO1 --> PL1["PL-01: Intelligent IS Dev"]
    PEO1 --> PL3["PL-03: Smart Sys Integrator"]
    PEO1 --> PL5["PL-05: Digital Governance Analyst"]
    PEO1 --> PL6["PL-06: Data & ML Engineer"]
    
    PEO2 --> PL2["PL-02: Platform Engineer"]
    PEO2 --> PL4["PL-04: Technopreneur"]
    
    PL1 & PL6 --> CPL_AI["CPL KK1, KK2, P2 (AI & Data)"]
    PL3 & PL5 --> CPL_INFRA["CPL KK3, KK4, P3 (Cloud, Cyber & GRC)"]
    PL2 & PL4 --> CPL_PLAT["CPL KK5, KK6, P4 (Platform & Startup)"]
    
    CPL_AI --> MK_P1["Peminatan P1: STA-01 s.d STA-06"]
    CPL_INFRA --> MK_P2["Peminatan P2: STB-01 s.d STB-06"]
    CPL_PLAT --> MK_P3["Peminatan P3: STC-01 s.d STC-06"]
```

...
## 4. SEMESTER 7 — Profesionalisasi (21 SKS)
...
## 5. RINGKASAN SEMESTER GANJIL — MK PRAKTIKUM
...
## 6. DAFTAR MK PRAKTIKUM SEMESTER GANJIL (Untuk Pelaporan MK Berbayar)
...
## 7. ESTIMASI KEBUTUHAN LABORATORIUM

| Laboratorium | MK yang Menggunakan | Kode | Semester |
|---|---|---|---|
| **Lab Komputer (Umum)** | Algoritma-Pemrograman, API, Sistem Cerdas, Web, DW-BI, Data Mining, Startup Digital | FST-101, STI-301, STI-302, STI-306, STI-502, STI-503, STI-703 | 1, 3, 5, 7 |
| **Lab IoT/Sensor** | IoT, Smart Surveillance | STI-305, STI-702 | 3, 7 |
| **Lab GPU/AI** | Deep Learning, Conversational AI | STI-501, STI-701 | 5, 7 |
| **Lab sesuai Pilihan** | MK Pilihan P1/P2/P3 | STA-/STB-/STC- | 5, 7 |

---

## 8. CATATAN

1. **Semester Ganjil** = Semester 1, 3, 5, 7 (jumlah ganjil)
2. **MK Praktikum** = MK yang memiliki komponen praktikum (+P) — memerlukan lab/biaya tambahan
3. **MK Pilihan Peminatan** (Sem 5 & 7) = Semua MK pilihan memiliki komponen praktikum (+P)
4. **Biaya MK Berbayar** = Biaya lab per SKS praktikum (menyesuaikan kebijakan universitas)
5. **Total SKS Praktikum Ganjil** = 50 SKS dari 82 SKS total (61% praktikum)
6. **MK Paralel** = Metodologi Penelitian (FST-108), Pra-Skripsi (FST-110) bisa diambil di Ganjil atau Genap
...
| Dokumen | Fungsi |
|---|---|
| `011_STRUKTUR_KURIKULUM_TABEL.md` | Sumber utama struktur kurikulum per semester |
| `006_KEPUTUSAN_FINAL_ARAH_KURIKULUM_SISTEKIN.md` | Keputusan final arah kurikulum |
| `KURIKULUM2025/Laporan Daftar Kurikulum Prodi Sistekin.pdf` | **Ground Truth:** Kurikulum lama (56 MK, 146 SKS) — file terverifikasi manusia, sudah dijalankan 2 semester |

---

*Dokumen ini untuk pelaporan MK Berbayar (Praktikum) Semester Ganjil Kurikulum SISTEKIN.*
